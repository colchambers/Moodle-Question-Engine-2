...
$CFG->dbhost    = 'raven.open.ac.uk';   // eg localhost or db.isp.com
$CFG->dbname    = 'cc5983';      // database name, eg moodle
$CFG->dbuser    = 'vle-dev';    // your database username
$CFG->dbpass    = 'vl3-d3v$';    // your database password
$CFG->prefix    = 'vle_qe2_mdl_';        // Prefix to use for all table names
...
$CFG->wwwroot   = 'http://cc5983.vledev.open.ac.uk/vle/20101224/Moodle-Question-Engine-2/moodle';
...
$CFG->dirroot   = '/fs2/www/html/cc5983/vle/20101224/Moodle-Question-Engine-2/moodle';
...
$CFG->dataroot  = '/fs2/www/html/cc5983/vle/20101224/Moodle-Question-Engine-2/data';
